...
//
//  Created by Artak Martirosyan on 22.12.25.
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func demo() {
        ...
        let request = URLRequest(url: url, cachePolicy: .reloadIgnoringLocalAndRemoteCacheData, timeoutInterval: 32.0)
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> Swift.Result<[FeedImage], Error>? {
